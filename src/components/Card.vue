<template>
  <div :key="Date.now() * Math.random()" class="card flex-auto w-full bg-black relative grid grid-cols-4 grid-rows-1 overflow-hidden transition duration-300 border-b border-gray-600">
