<template>
  <transition name="fade" appear>
    <div :key='key' v-show="percent" :style="{width: cssPercent, 'background-color':cssBackground}" class="absolute opacity-75 top-0 left-0 h-full transition-all duration-300 ease-linear bg-yellow-400"></div>
  </transition>
</template>
